          ...
          <Col md='4'>
            <div className='widget white-bg'>
              <div className='padding-20 text-center'>
                ...
                <p className='text-sm margin-b-0'>
            ...
            <div className='widget white-bg friends-group clearfix'>
              ...
              <div className='map-box'>
                <iframe
                  src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d195868.3954179315!2d32.746964926889376!3d39.90908623136076!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14d347d520732db1%3A0xbdc57b0c0842b8d!2sAnkara%2C+T%C3%BCrkiye!5e0!3m2!1str!2sin!4v1523713774785'
                  width='100%'
                  height={150}
                  frameBorder={0}
                  style={{ border: 0 }}
              ...
              <Card.Body>
                <form method='post' className='well well-default'>
                  ...
                  <div className=' float-right'>
                    <Link to='#be' className='btn btn-primary'>
                      Send
                    </Link>
                  </div>
                ...
                <div className='tabs'>
                  ...
                  <div className='tab-content'>
                        ...
                        <ul className='comments-list list-unstyled clearfix'>
                          <li className='clearfix'>
                            <img
                              ...
                              alt=''
                              width={70}
                              className='rounded-circle circle-border'
                            />
                            <div className='content'>
                              ...
                              <p>
                                Lorem ipsum industry's standard dummy text ever
                              ...
                              <ul className='list-inline row'>
                                ...
                                <li className='nav-item'>
                                  <Link className='nav-link' href='#be'>
                                    <i className='fa fa-thumbs-up text-danger' />{" "}
                                    145
                                  </Link>
                                </li>
                                <li className='nav-item'>
                                  <Link className='nav-link' href='#be'>
                                    <i className='fa fa-reply text-danger' />{" "}
                                    Reply
                                  </Link>
                                </li>
                              </ul>
                    ...
                    <div role='tabpanel' className='tab-pane' id='profile'>
                      <div className='widget white-bg'>
                        <Row>
                          <div className='col-md-2 col-xs-6 b-r'>
                            {" "}
                            <strong>Full Name</strong>
                            <br />
                            <p className='text-muted'>John Deo</p>
                          </div>
                          <Col md='4' xs='6' className='b-r'>
                            {" "}
