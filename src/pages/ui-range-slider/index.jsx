    ...
    return (
      <React.Fragment>
        <Row>
          <Col md='12'>
            <Card>
              <Card.Header>Sliders</Card.Header>
              <Card.Body>
                <Row>
                  <Col>
                    <h5>
                      <small>Basic Slider</small>
                    </h5>
                ...
                <Row>
                  <Col>
                    <h5>
                      <small>Negative Values (No Tooltip)</small>
                    </h5>
                    <div className='slider'>
                      <Slider
                        min={-20}
                ...
                <Row>
                  <Col>
                    <h5>
                      <small>Custom Labels & Formatting</small>
                    </h5>
