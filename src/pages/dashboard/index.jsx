            ...
            <React.Fragment>
                <Row className="w-no-padding margin-b-30">
                    ...
                    <div className="widget  bg-light">
                        ...
                        <div className="margin-b-30">
                            ...
                            <span className="float-right text-primary widget-r-m">37859</span>
                        </div>
                        <div className="progress margin-b-10  progress-mini">
                            <div style={{width: '50%'}} className="progress-bar bg-primary" />
                        </div>
                    ...
                    <div className="widget  bg-light">
                        ...
                        <div className="margin-b-30">
                            ...
                            <span className="float-right text-indigo widget-r-m">1758</span>
                        </div>
                        <div className="progress margin-b-10 progress-mini">
                            <div style={{width: '45%'}} className="progress-bar bg-indigo" />
                        </div>
                        <p className="text-muted float-left margin-b-0">Change</p>
                    ...
                    <div className="widget  bg-light">
                        ...
                        <div className="margin-b-30">
                            ...
                            <span className="float-right text-success widget-r-m">1385</span>
                        </div>
                        <div className="progress margin-b-10 progress-mini">
                            <div style={{width: '85%'}} className="progress-bar bg-success" />
                        </div>
                        <p className="text-muted float-left margin-b-0">Change</p>
                    ...
                    <div className="widget  bg-light">
                        ...
                        <div className="margin-b-30">
                            ...
                            <span className="float-right text-warning widget-r-m">98421</span>
                        </div>
                        <div className="progress margin-b-10 progress-mini">
                            <div style={{width: '38%'}} className="progress-bar bg-warning" />
                        </div>
                        <p className="text-muted float-left margin-b-0">Change</p>
                ...
                <Row>
                    ...
                    <Card>
                        ...
                        <ul className="list-1 list-group">
                            <li className="list-group-item">Desktop <span className="float-right text-indigo"><i className="fa fa-arrow-up" /> 45.0%</span></li>
                            <li className="list-group-item">Mobile <span className="float-right text-primary"><i className="fa fa-minus" /> 25.0%</span></li>
                            <li className="list-group-item">Tablet <span className="float-right text-teal"><i className="fa fa-arrow-down" /> 15.0%</span></li>
                            <li className="list-group-item">Other <span className="float-right text-muted"><i className="fa fa-arrow-up" /> 15.0%</span></li>
                        </ul>
                        </Card.Body>
                    </Card>
                    </Col>
                ...
                <Row>
                    ...
                    <Card>
                        ...
                        <div className="scrollDiv">
                            ...
                            <li>
                                ...
                                <label htmlFor="checkbox4"> Lorem Ipsum is simply dummy text of the 	<small className="label label-primary"><i className="fa fa-clock-o" /> 3 Mins</small></label>
                                </div>
                            </li>
                    ...
                    <Card>
                        ...
                        <div className="scrollDiv">
                            <ul as="ul" className="chat-list list-unstyled" style={{
                                position: "relative",
                                height: "270px",
                                overflowY: "scroll",
                            }}>
                            ...
                            <li className="clearfix chat-element media">
                                ...
                                <div className="speech-box">
                                    ...
                                    <small className="text-info">Today 12:31 pm - 10.08.2018</small>
                                </div>
                                </div>
                            </li>
                    ...
                    <Card>
                        ...
                        <div className="profiletimeline">
                            ...
                            <div className="sl-right">
                                ...
                                <Row className="mt-2">
                                    <Col md="3" xs="12">
                                        <img src="/assets/img/gallery/1s.jpg" alt="user" className="img-fluid rounded" />
                                    </Col>
                                    <Col md="9" xs="12">
                            ...
                            <div className="sl-right">
                                <div>
                                    <Link to="#be" className="link">John Doe</Link> 
                    ...
                    <Card>
                        ...
                        <Table borderless className="browser">
                            ...
                            <tr>
                                ...
                                <td>Google Chrome</td>
                                <td className="text-right"><span className="label label-primary">33%</span></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/browser/firefox-logo.png" alt="logo" /></td>
                                <td>Mozila Firefox</td>
                                <td className="text-right"><span className="label label-success">27%</span></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/browser/safari-logo.png" alt="logo" /></td>
                                <td>Apple Safari</td>
                                <td className="text-right"><span className="label label-info">17%</span></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/browser/internet-logo.png" alt="logo" /></td>
                                <td>Internet Explorer</td>
                                <td className="text-right"><span className="label label-warning">11%</span></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/browser/opera-logo.png" alt="logo" /></td>
                                <td>Opera mini</td>
                                <td className="text-right"><span className="label label-danger">8%</span></td>
                            </tr>
                            <tr>
                                <td><img src="/assets/img/browser/internet-logo.png" alt="logo" /></td>
                                <td>Microsoft edge</td>
                                <td className="text-right"><span className="label label-indigo">4%</span></td>
                            </tr>
                            </tbody>
                        </Table>
                        </Card.Body>
