                ...
                <Form>
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      className='Form-control input-lg m-b'
                    />
                    <br />
                    <Form.Control
                      type='text'
                  ...
                  <Form.Group>
                    ...
                    <InputGroup className='m-b'>
                      <InputGroup.Prepend>
                        <InputGroup.Text>
                          <Form.Check type='checkbox' id='checkboxrf444' />
                        </InputGroup.Text>
                      </InputGroup.Prepend>
                      <Form.Control type='text' />
                    </InputGroup>
                    ...
                    <InputGroup>
                      <InputGroup.Text>
                        <Form.Check type='radio' id='checkboxrf4445' />
                      </InputGroup.Text>
                      <Form.Control type='text' />
                    </InputGroup>
                  </Form.Group>
          ...
          <Col md='12'>
            <Card>
              ...
              <Card.Body>
                <Form inline>
                  <Form.Group>
                    <Form.Label htmlFor='input-email' className='sr-only'>
                      Email address
                    </Form.Label>
                    <Form.Control
                      type='email'
                  ...
                  <Form.Group className='mx-sm-3'>
                    <Form.Label htmlFor='input-password' className='sr-only'>
                      Password
                    </Form.Label>
                    <Form.Control
                      type='password'
                  ...
                  <Button type='submit' className='margin-l-5 mx-sm-3'>
                    Sign in
                  </Button>
                </Form>
              </Card.Body>
